...
// Admin password must be set via environment variable - no fallback for security
if (!process.env.ADMIN_PASSWORD) {
  throw new Error("ADMIN_PASSWORD environment variable must be set for admin authentication");
}
